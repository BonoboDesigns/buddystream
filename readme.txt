...
= 3.2.6 =
* Updated Flickr API
* Updates Soundcloud API

= 3.2.5 = 
* Fixed LinkedIn import due API change.

= 3.2.4 =
* Fixed directory separator for windows installs
* Check compatibility for new WordPress and BuddyPress
* Added missing Facebook Pages settings page
...
* fixed import for installs where plugin directory is other then wp-content (local cron)
