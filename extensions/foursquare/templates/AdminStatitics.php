...
<div id="buddystream" class="container">
    <div class="span9">
        ...
        <blockquote>
            <p>
                <?php _e('foursquare statitics description', 'buddystream');?>
            </p>
        </blockquote>
        ...
        <table class="table table-striped" cellspacing="0">
            ...
            $count_foursquareusers = count($wpdb->get_results("SELECT user_id FROM $wpdb->usermeta WHERE meta_key='buddystream_foursquare_token';"));
            $perc_foursquareusers = round(($count_foursquareusers / $count_users) * 100);
            $count_items = count($wpdb->get_results("SELECT type FROM " . $bp->activity->table_name . " WHERE type='foursquare';"));
        ...
        <tr>
            <td>" . __('Amount of user Foursquare intergration:', 'buddystream') . "</td>
            <td>" . $count_foursquareusers . "</td>
        </tr>
        <tr>
            <td>" . __('Percentage of users using intergration:', 'buddystream') . "</td>
            <td>" . $perc_foursquareusers . "%</td>
        </tr>
        <tr>
