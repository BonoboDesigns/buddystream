...
<div id="buddystream" class="container">
    <div class="span9">
        ...
        <blockquote>
            <p>
                <?php _e('tumblr statitics description', 'buddystream');?>
            </p>
        </blockquote>
        ...
        <table class="table table-striped" cellspacing="0">
            ...
            $count_tumblrusers = count($wpdb->get_results("SELECT user_id FROM $wpdb->usermeta WHERE meta_key='buddystream_tumblr_token';"));
            $perc_tumblrusers = round(($count_tumblrusers / $count_users) * 100);
            $count_items = count($wpdb->get_results("SELECT type FROM " . $bp->activity->table_name . " WHERE type='tumblr';"));
        ...
        <tr>
            <td>" . __('Amount of user Tumblr intergration:', 'buddystream') . "</td>
            <td>" . $count_tumblrusers . "</td>
        </tr>
        <tr>
            <td>" . __('Percentage of users using intergration:', 'buddystream') . "</td>
            <td>" . $perc_tumblrusers . "%</td>
        </tr>
        <tr>
