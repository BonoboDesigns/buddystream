...
?>
        ...
        <?php if (get_site_option("buddystream_facebookWall_power") && get_site_option("buddystream_facebookWall_export")): ?>
                        ...
                        if ($items->data) {
                            foreach ($items->data as $page) {
                                if ($page->category != "Application") {
                                    ...
                                    $checked = "";
                                    if (in_array($page->id . ':' . $page->access_token, $savedFacebookPages)) {
                                        $checked = "checked";
                                    }
        ...
        <input type="submit" name="submit" class="buddystream_save_button"
               value="<?php echo __('Save settings', 'buddystream_lang');?>">
